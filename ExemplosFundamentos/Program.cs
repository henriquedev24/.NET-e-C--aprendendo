...
Console.WriteLine($"{listaString.Count} itens na minha lista e capacidade {listaString.Capacity}");
...
// int[] arrayNumerosDobrados = new int[arrayNumeros.Length * 2];
// Array.Copy(arrayNumeros, arrayNumerosDobrados, arrayNumeros.Length);

// // Array.Resize(ref arrayNumeros, arrayNumeros.Length * 2);

// int posicao = 0;
// foreach (int numero in arrayNumeros)
// {
//     Console.WriteLine($"Posição {numero}");
//     posicao++;
// }
